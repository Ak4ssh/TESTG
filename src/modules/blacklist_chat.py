...
from src.utils.dbfunctions import blacklist_chat, blacklisted_chats, whitelist_chat

ModuleName = "Blacklist Chat"
HELPS = """
...
@app.on_message(filters.command("blacklist_chat") & SUDO)
@capture_err
...
@app.on_message(filters.command("whitelist_chat") & SUDO)
@capture_err
...
@app.on_message(filters.command("blacklisted_chats") & SUDO)
@capture_err
