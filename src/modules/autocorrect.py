...
from src import SUDO, BOT_ID, USERBOT_PREFIX, app, app2, arq
from src.modules.userbot import eor
from src.utils.filter_groups import autocorrect_group
...
@app2.on_message(filters.command("autocorrect", prefixes=USERBOT_PREFIX) & SUDO)
...
@app2.on_message(
    filters.text & filters.user(BOT_ID),
